...
import ku.piii2017.businesslogic5.MediaItem;
import ku.piii2017.businesslogic5.MediaInfoSourceFromID3;
import java.io.File;
...
public class MediaInfoSourceFromID3Test {
    ...
    public void testAddMediaInfoID3v1() throws Exception {
        ...
        Path testPath = Paths.get(Workshop5TestHelper.TEST_SRC_FOLDER,
